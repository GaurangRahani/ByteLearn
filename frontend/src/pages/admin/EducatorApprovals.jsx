    ...
    <div className="min-h-screen bg-[#F8FAFC]">
      ...
      <main className="max-w-[1440px] mx-auto px-10 py-10 animate-in fade-in slide-in-from-bottom-5 duration-500">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
          <div>
            <h1 className="text-[32px] font-black text-slate-800 tracking-tight mb-1">Educator Approvals</h1>
                ...
                <div className="flex-grow overflow-y-auto p-10 space-y-10 custom-scrollbar bg-slate-50/20">
                   ...
                   <div>
                      <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-4 flex items-center gap-2">
                         <ShieldCheck size={14} className="text-blue-500" /> Supporting Credentials
                      </label>
                      <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                         {selectedEducator.educatorApplication?.supportingCredentials?.map((cred, i) => (
                            <a 
                              ...
                              className="group p-4 bg-white border border-slate-100 rounded-2xl flex flex-col items-center justify-center gap-2 hover:bg-blue-600 hover:border-blue-600 transition-all shadow-sm"
                            >
                               ...
                               <span className="text-[9px] font-black text-slate-400 group-hover:text-white uppercase tracking-widest text-center">DOCUMENT {i+1}</span>
                            </a>
                         ))}
                         {(!selectedEducator.educatorApplication?.supportingCredentials || selectedEducator.educatorApplication?.supportingCredentials.length === 0) && (
                            <div className="col-span-full py-10 bg-white rounded-2xl flex flex-col items-center justify-center text-slate-300 gap-2 border border-dashed border-slate-100 font-bold uppercase tracking-widest text-xs">
                               <AlertCircle size={24} />
